Program ProjetQwirckle;

uses Crt, Uinitialisation, Ufonctionsannexes, Ujeu, Uaffichage;
...
VAR
   nomJou	       	  : string;
   choixNbrJou, i, ageJou,j : integer;
   jeu1			  : jeu;
BEGIN
CASE choix OF
1 : begin
	  ...
	  jeu1.tabJoueurs[i].nom:=nomJou;
       ...
       begin
	  j:=j+1;
	  jeu1:=Tour(jeu1,j MOD 2);
       end;
       until high(jeu1.pioche)=0;
    end;
ELSE
   writeln('Bye');
END;
